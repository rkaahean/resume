...
to backend APIs with Typescript - thereby saving $\sim$\$80k/year by phasing out vendors.}
        \resumeItem{Developed a XGBoost-based Python pipeline that cut referral fraud by 60\% and saved \$350k, identifying high-risk users for Enhanced Due Diligence during onboarding.}
