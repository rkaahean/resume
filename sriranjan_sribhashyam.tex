...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     \textbf{Languages \& Frameworks}{: SQL, Python, JavaScript \& Typescript with Node.js, React with Next.js, Tailwind CSS} \\
     ...
     \textbf{Data Management}{: pandas \& dask, Snowflake, FiveTran, PostgreSQL, DBT, ORMs (TypeORM, SQLAlchemy, Prisma)}
    }} \\
